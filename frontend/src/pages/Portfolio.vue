<template>
  <div class="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-pink-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
    <div class="max-w-7xl mx-auto px-4 py-8 space-y-6">
        ...
        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div class="flex gap-4">
            <div class="bg-white/10 backdrop-blur-sm border-2 border-white/30 rounded-2xl px-6 py-4">
              ...
              <div class="text-3xl font-black text-white">{{ userProfile.totalCards }}</div>
            </div>
            <div class="bg-white/10 backdrop-blur-sm border-2 border-white/30 rounded-2xl px-6 py-4">
              <div class="flex items-center gap-2 text-white/80 text-sm mb-1">
              ...
              <div class="text-3xl font-black text-yellow-300">S${{ userProfile.portfolioValue }}</div>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              <div class="relative p-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-slate-600 dark:to-slate-700">
                ...
                <div v-if="card.quantity > 1" class="absolute top-2 left-2 px-3 py-1 bg-purple-500 text-white text-sm font-bold rounded-full">
                  x{{ card.quantity }}
                </div>
              </div>
          ...
          <div class="space-y-3">
            ...
            >
              ...
              <div class="text-right">
                ...
                <span class="inline-block px-2 py-1 bg-green-100 dark:bg-green-900 text-green-600 dark:text-green-300 text-xs font-semibold rounded">
                  {{ transaction.status }}
                </span>
              </div>
            </div>
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="number"
                  v-model.number="newCard.quantity"
                  class="w-full px-4 py-3 border-2 border-gray-200 dark:border-slate-700 rounded-xl focus:border-indigo-500 focus:outline-none dark:bg-slate-900"
                  min="1"
                />
              </div>
      ...
      <!-- Edit Card Modal -->
      <div v-if="showEditModal && editingCard" class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div class="bg-white dark:bg-slate-800 rounded-3xl p-8 max-w-md w-full shadow-2xl">
          <div class="flex items-center justify-between mb-6">
...
// User profile data HARD-CODED
const userProfile = ref({
  name: 'Alex Chen',
  email: 'alex.chen@email.com',
  joinDate: 'Jan 2025',
  totalCards: 12,
  portfolioValue: 1845.00
})

// User's card collection HARD-CODED
