...
- **PSA-Certified Cards** - Real certification numbers and high-res images
...
│   │   │   ├── LandingPage.vue
│   │   │   ├── Messages.vue
│   │   │   ├── Profile.vue          # Portfolio tab with chart
│   │   │   ├── Login.vue
│   │   │   └── SignUp.vue
│   │   ├── composables/
...
**Frontend:** Vue 3, Vue Router, Tailwind CSS, Vite, Socket.IO Client, TradingView Lightweight Charts  
**Backend:** Node.js, Express, Socket.IO, JWT, bcrypt  
**Database:** Firebase Firestore  
**APIs:** PSA API, Pokemon TCG API
